...
<script id="realms_template" type="text/template">
    <% _.each( realms, function( realm ){ %>
        ...
        <% } %>
            ...
            <td><%- realm.loves %></td>
            <td>
                <a class="btn btn-default btn-xs" href="editor.php?id=<%- realm.id %>&source=<%- realm.source ? realm.source : 'source-01' %>"><span class="glyphicon glyphicon-fire"></span> Edit Code</a>
